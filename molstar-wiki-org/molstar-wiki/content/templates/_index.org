...
Templates let you save, share, and switch between complete scene configurations.
...
Built-in presets cannot be edited or deleted. They are defined in =config.js= — see [[../developer/contributing][Contributing]] if you want to add one.
