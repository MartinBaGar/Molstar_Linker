...
### Why did my massive molecule (or MD trajectory) fail to load? {#why-did-my-massive-molecule--or-md-trajectory--fail-to-load}
...
### Why don’t labels appear in the scene? {#why-don-t-labels-appear-in-the-scene}

If labels are not appearing, check the following:

-   Ensure that labels are enabled in the **Scene Settings** section of the Studio.
-   Verify that the **Text Color** contrasts with the **Canvas Background Color** (e.g., white text on a white background will not be visible).
-   Check that the **Label Size** is large enough to be visible.
