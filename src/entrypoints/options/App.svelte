...
<main class="container" on:input={triggerUnsaved}>
    <header class="doc-header">
        ...
        <nav class="links">
            ...
            >
            <a href="https://ko-fi.com/mabagar" target="_blank" class="donate"
                >☕ Donate</a
            >
        </nav>
    </header>
        ...
        <div id="custom-rules-container">
            {#each customRules as rule, i (rule.meta?.id)}
                <details class="target-card custom-rule-card rule-card" open>
                    <summary>
                        <span class="rule-title-display"
                            >{rule.meta?.name || "Unnamed Rule"}</span
                        >
                        <button
                            class="btn-danger delete-rule-btn"
                            on:click|preventDefault|stopPropagation={() =>
                                removeRule(i)}>Delete</button
                        >
                    </summary>
    ...
    <section class="panel">
            ...
            {:else}
                {#each customDomains as domain}
                    <div class="domain-row">
                        ...
                        <button
                            class="btn-danger remove-domain-btn"
        ...
        <div class="domain-input-group">
            ...
            />
            <button on:click={addDomain} class="btn-secondary"
                >+ Add Domain</button
            >
        </div>
    </section>
