...
** =src/mvs-builder.ts=
Translates extension settings into a [[https://molstar.org/viewer-docs/extensions/mvs/][MolViewSpec]] JSON tree. All user-controlled values are sanitized before being embedded.
